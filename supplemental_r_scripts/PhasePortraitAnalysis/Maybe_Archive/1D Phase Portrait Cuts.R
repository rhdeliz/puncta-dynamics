# LinearPhasePortrait <- fread(paste0("/Users/u_deliz/Desktop/PhasePortraitAnalysis/Normalized PhasePortrait - LeadLag ", LEAD_LAG, " - StepSize ", STEP_SIZE, ".csv.gz"))
# LinearPhasePortrait <- LinearPhasePortrait %>% filter(QUERY_PROTEIN != "TRAF6") %>% as.data.table()

FRAMES_SINCE_LANDING_CAT_BINS <- c(1:4)*50
